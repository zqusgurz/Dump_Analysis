...
--if (r < 0.33) then
--    _ChatMessageLogic:Add(_ChatMessageType.Creator, string.format("%s : %s", u.FullName, text))
--elseif (r < 0.66) then
--    _ChatMessageLogic:Add(_ChatMessageType.Channel, string.format("%s : %s", u.FullName, text))
--else
--    _ChatMessageLogic:Add(_ChatMessageType.NormalChat, string.format("%s : %s", u.FullName, text))
--end
-- self.ChatInputText.TextInputComponent:ActivateInputField()
end