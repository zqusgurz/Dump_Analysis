...
for i=1,digitCount do
	...
	entity.SpriteGUIRendererComponent.ImageRUID = _SpriteCharacterRUIDLogic.ItemNumberSecondDigits[tostring(digit)].RUID
	entity.UITransformComponent.RectSize.x = width
	entity.UITransformComponent.anchoredPosition.x = x
